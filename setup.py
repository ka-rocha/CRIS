#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Copyright (C) Kyle Rocha (2019)
#
# This file is part of the cris python package.
#
...
PACKAGENAME = 'cris'
DISTNAME = 'cris' #'YOUR DISTRIBTUION NAME (I.E. PIP INSTALL DISTNAME)' Generally good to be same as packagename
AUTHOR = 'Kyle Rocha'
AUTHOR_EMAIL = 'kylerocha2024@u.northwestern.edu'
LICENSE = 'GPLv3+'
